...
I have to note that I did not have the time to properly test this circuit and build it, and it might not be functional. Therefore, use it at your own risk. <br>
...
## Interface
When the oscilloscope is stopped, you can press the arrow button to send the captured waveform through the COM port into the PC. <br>
...
BTC:<br>
3BLXniEthLFhRLVYFCvtcK91qJPbp14w3J


ETH (ERC20):<br>
0x43EC1F539E34809645A6ae6eC9D3ca8Cf19b666E

PayPal: <br>
paypal.me/MMahdiMohammadi
